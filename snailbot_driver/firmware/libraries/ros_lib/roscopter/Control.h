#ifndef _ROS_roscopter_Control_h
#define _ROS_roscopter_Control_h
...
namespace roscopter
{
  ...
  class Control : public ros::Msg
  {
    ...
    const char * getType(){ return "roscopter/Control"; };
    const char * getMD5(){ return "f2b64ccef8f731e7d5b721d65f7d91ec"; };
